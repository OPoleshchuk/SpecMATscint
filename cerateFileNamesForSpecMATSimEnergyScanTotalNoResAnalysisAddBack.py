...
for i in range(20, 300, 10):
    ...
    j = formatNumber(j)
    print(j)
    f.write('convertRoot("AddBack_CeBr3_48mmx48mmx48mm_15x1x3crystals_R131.25mm_gamma' + str(j) + 'MeV_Aluminum5083_Chamber_wallThick_3mm_point_sourcePosition_129mm_FCEpoxy_epoxy_gap3mm", ' + str(j) + ', ' + str(i) + ',1);\n')
