...
#ifndef SpecMATSimUniformEMField_H
#define SpecMATSimUniformEMField_H 1
...
class SpecMATSimUniformEMField: public G4ElectroMagneticField {
...
public:
  ...
  SpecMATSimUniformEMField();
  SpecMATSimUniformEMField(const G4ThreeVector magFieldVector, 
			 const G4ThreeVector elecFieldVector);
  SpecMATSimUniformEMField(const  SpecMATSimUniformEMField &p); 
  ~SpecMATSimUniformEMField();  
  
  //assignment operator
  SpecMATSimUniformEMField operator = (const SpecMATSimUniformEMField &p);
