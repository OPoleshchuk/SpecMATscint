...
#
#\file SpecMATSimEnergyScan.sh
#
#This script is used for automatic scanning over a point source energy determined
#by the "gammaEnergy=" variable in the /src/SpecMATSimPrimaryGeneratorAction.cc
...
sed -i "s/$ea/$eb/g" ../SpecMATscint/src/SpecMATSimPrimaryGeneratorAction.cc
