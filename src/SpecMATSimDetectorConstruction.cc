  ...
  emField(0)
{
  ...
  */
  ...
  emField = new SpecMATSimUniformEMField();
}
...
void SpecMATSimDetectorConstruction::UpdateEMField() {
    //
...
void SpecMATSimDetectorConstruction::SetEleField(G4ThreeVector eVector){
    //
...
void SpecMATSimDetectorConstruction::SetMagField(G4ThreeVector mVector){
    //
