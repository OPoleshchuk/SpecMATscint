...
#include "SpecMATSimUniformEMField.hh"
...
SpecMATSimUniformEMField::SpecMATSimUniformEMField() {
  //
  //  Default zero field constructor
  //
  fieldComponents[0] = fieldComponents[1] = 0.;
  fieldComponents[2] = 4. * tesla;
  fieldComponents[3] = fieldComponents[4] = 0.;
  fieldComponents[5] = -2.0E+6*volt/m;
...
SpecMATSimUniformEMField::SpecMATSimUniformEMField(const G4ThreeVector magFieldVector,
...
SpecMATSimUniformEMField::SpecMATSimUniformEMField(const  SpecMATSimUniformEMField &p)
...
SpecMATSimUniformEMField SpecMATSimUniformEMField::operator = (const SpecMATSimUniformEMField &p) {
...
void SpecMATSimUniformEMField::SetFieldValue(const G4ThreeVector magFieldVector,
					   const G4ThreeVector elecFieldVector) {
  //
...
void SpecMATSimUniformEMField::SetPureElectricFieldValue(G4ThreeVector fieldVector) {
  //
...
void SpecMATSimUniformEMField::SetPureMagneticFieldValue(G4ThreeVector fieldVector) {
  //
...
void SpecMATSimUniformEMField::GetFieldValue(const G4double thePoint[4],
...
G4ThreeVector SpecMATSimUniformEMField::GetMagneticFieldValue() {
  //
...
G4ThreeVector SpecMATSimUniformEMField::GetElectricFieldValue() {
  //
...
G4FieldManager*  SpecMATSimUniformEMField::GetGlobalFieldManager() {
  //
...
void SpecMATSimUniformEMField::DefineUnits() {
   //
